    ...
    >
      ...
      <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <p className="text-lg text-[var(--text-secondary)] leading-relaxed max-w-2xl mx-auto mb-10">
          Three design-partner slots remain in Q3 2026. White-glove onboarding,
          shared Slack channel, six months free, founder on-call. Bring one bug
          ticket and one repo — we&apos;ll do the rest.
        </p>
        <div className="flex flex-wrap items-center justify-center gap-3">
          <Link
            href="mailto:ryan@speechlab.ai?subject=complex-ui-tester%20design%20partner"
