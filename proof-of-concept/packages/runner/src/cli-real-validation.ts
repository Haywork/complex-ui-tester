 ...
 *
 * Runs the @haywork/cuit-spec-gen-shaped loop against a session fixture captured
 ...
 *
 * The rule-based generator in @haywork/cuit-spec-gen v0.1 hard-codes the
...
function serializeSpec(args: {
  ...
  return [
    ...
    `// __waveformDebug API exposes the production-equivalent of @haywork/cuit-harness;`,
...
async function main(): Promise<void> {
  ...
  emit(`          CUIT @haywork/cuit-harness  → dispatchDrag(...)`);
