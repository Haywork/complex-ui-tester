...
import type { SessionEvent, PointerEvent as CuitPointerEvent, Primitive } from '@haywork/cuit-types';
import {
  minimalDiff,
  stepState,
  listPrimitives,
...
describe('listPrimitives', () => {
  ...
  test('setClock and dispatchDrag are marked executable — they call into @haywork/cuit-harness via runPrimitive', () => {
    const entries = listPrimitives();
