/**
 * Generality proof for @cuit/spec-gen.
 *
 ...
 * Make them green by:
 *   1. Adding KeyboardEvent to @cuit/types and dispatchClick/dispatchType Primitive kinds.
...
import type { SessionEvent, StateSnapshotEvent } from '@cuit/types';
 ...
 *
 * NOTE: KeyboardEvent is not yet part of @cuit/types. Adding it is part of the
